...
export const AircraftName: React.FC<{
  ...
  const { t } = useTranslation("translation", {
    keyPrefix: "travel.immigration.aircraftName",
  });
  ...
  return (
    <TextField
      ...
      label={labelText}
      defaultValue={value}
      data-testid="immigration-aircraftName"
      required
...
export const AircraftCompany: React.FC<{
  ...
  const { t } = useTranslation("translation", {
    keyPrefix: "travel.immigration.aircraftCompany",
  });
  ...
  return (
    <TextField
      ...
      label={labelText}
      defaultValue={value}
      data-testid="immigration-aircraftCompany"
      required
...
export const SeatNumber: React.FC<{
  ...
  const { t } = useTranslation("translation", {
    keyPrefix: "travel.immigration.seatNumber",
  });
  ...
  return (
    <TextField
      ...
      label={labelText}
      defaultValue={value}
      data-testid="immigration-seatNumber"
      required
